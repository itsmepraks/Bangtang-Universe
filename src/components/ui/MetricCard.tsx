...
export default function MetricCard({ label, value, icon: Icon, accent, subtitle, size = 'md', className = '' }: MetricCardProps) {
  return (
    <div className={`${padding[size]} rounded-2xl bg-white/[0.03] border border-white/[0.06] transition-colors duration-300 hover:border-white/[0.12] hover:bg-white/[0.05] ${className}`}>
